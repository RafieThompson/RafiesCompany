...
namespace RafiesCompany.Other
{
    public class ModConfig
    {
        ...
        public void InitConfigEntries()
        {
            ...
            SprintMeter = RafiesCompanyBase.instance.Config.Bind<bool>(SectionGeneral, "SprintMeter", true, "Unlimited Sprint");
            ...
            DeadlineDays = RafiesCompanyBase.instance.Config.Bind<int>("Deadline", "DeadlineDays", 3, "Days until the deadline.");

            EnableQuotaModification = RafiesCompanyBase.instance.Config.Bind<bool>("Quota", "EnableQuotaModification", true, "False sets to vanilla value.");
            ...
            EnableCreditModification = RafiesCompanyBase.instance.Config.Bind<bool>("Credits", "EnableCreditModification", true, "False sets to vanilla value.");
            StartingCredits = RafiesCompanyBase.instance.Config.Bind<int>("Credits", "StartingCredits", 80, "Starting credits.");
            PassiveCredits = RafiesCompanyBase.instance.Config.Bind<int>("Credits", "PassiveCredits", 120, "Passive credits at the start of every level.");
            ...
            //MinScrapModifier = RafiesCompanyBase.instance.Config.Bind<int>("Scraps", "MinScrapModifier", 0, "Added to the minimum total number of scraps in a level.");
            //MaxScrapModifier = RafiesCompanyBase.instance.Config.Bind<int>("Scraps", "MaxScrapModifier", 45, "Added to the maximum total number of scraps in a level.");
            //MinScrapValueModifier = RafiesCompanyBase.instance.Config.Bind<int>("Scraps", "MinScrapValueModifier", 0, "Added to the minimum total value of scraps in a level.");
            //MaxScrapValueModifier = RafiesCompanyBase.instance.Config.Bind<int>("Scraps", "MaxScrapValueModifier", 800, "Added to the maximum total value of scraps in a level.");
            ...
            //MaxInsideEnemyPowerModifier = RafiesCompanyBase.instance.Config.Bind<int>("Enemies", "MaxInsideEnemyPowerModifier", 2000, "Added to the maximum enemy power for inside enemies, this controls the maximum level difficulty.");
            //MaxOutsideEnemyPowerModifier = RafiesCompanyBase.instance.Config.Bind<int>("Enemies", "MaxOutsideEnemyPowerModifier", 20, "Added to the maximum enemy power for outside enemies, this controls the maximum level difficulty.");
            //MaxDaytimeEnemyPowerModifier = RafiesCompanyBase.instance.Config.Bind<int>("Enemies", "MaxDaytimeEnemyPowerModifier", 200, "Added to the maximum enemy power for daytime enemies, this controls the maximum level difficulty.");
            ...
            //EnableHazardModification = RafiesCompanyBase.instance.Config.Bind<bool>("Hazards", "EnableHazardModification", true, "False sets to vanilla value.");
            ...
            EventProbability = RafiesCompanyBase.instance.Config.Bind<int>("Events", "EventProbablity", 4, "Value from 0 to 10. 0 there's almost always an event and 10 there's never an event.");
            ...
            FlowermanCoilEventCoilHeadMax = RafiesCompanyBase.instance.Config.Bind<int>("FlowermanCoilEvent", "FlowermanCoilEventCoilHeadMax", 5, "Maximum number of coil head during the event (capped by power modifier).");
            ...
            HoardingBugsEventHoardingMax = RafiesCompanyBase.instance.Config.Bind<int>("HoardingBugsEvent", "HoardingBugsEventHoardingMax", 15, "Maximum number of hoarding bugs during the event (capped by power modifier).");
            ...
            JetpackEventJetpackCount = RafiesCompanyBase.instance.Config.Bind<int>("JetpackEvent", "JetpackEventJetpackCount", 5, "Number of jetpacks during the jetpack event.");
            ...
            SpiderEventSpiderMax = RafiesCompanyBase.instance.Config.Bind<int>("SpiderEvent", "SpiderEventSpiderMax", 6, "Maximum number of spiders during the event (capped by power modifier).");
            ...
            ThumperEventThumperMax = RafiesCompanyBase.instance.Config.Bind<int>("ThumperEvent", "ThumperEventThumperMax", 6, "Maximum number of thumper during the event (capped by power modifier).");
            ...
            JesterEventJesterMax = RafiesCompanyBase.instance.Config.Bind<int>("JesterEvent", "JesterEventJesterMax", 4, "Maximum number of jester during the event (capped by power modifier).");
